...
<body>
    <table>
        ...
        <tr>
            ...
            <td class="one">
                <input class="wz" type="text" value="">
            </td>
            <td class="one">性别</td>
            <td class="one">
                <input class="wz" type="text" value="">
        ...
        <tr>
            ...
            <td class="two" colspan="3">
                <input class="wz1" type="text" value="">
            </td>
            <td class="one">联系电话</td>
            <td class="one">
                <input class="wz" type="number" maxlength="11" value="">
            </td>
        </tr>
        <tr class="b">
            <td class="one_1">来电主要内容</td>
            <td class="two_2" colspan="5">
                <textarea class="wz2" ></textarea>
            </td>
        </tr>
        <tr class="b">
        ...
        <tr>
            ...
            <td class="two_3" colspan="5">
                <input class="wz5" type="text" value="">
            </td>
        </tr>
        <tr>
