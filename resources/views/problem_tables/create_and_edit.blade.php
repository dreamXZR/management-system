                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="main[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $problem_table->main))){echo 'selected';}?>>{{$address->all_present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="secondary[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $problem_table->secondary))){echo 'selected';}?>>{{$address->all_present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="join[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $problem_table->join))){echo 'selected';}?>>{{$address->all_present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    @if($problem_table->id)
       get_images('img',"{{route('images.index',['model'=>'problem_tables-'.$problem_table->id])}}");
    @else
        init_multiple('img',[],[]);
    @endif
</script>
