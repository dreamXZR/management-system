        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                     ...
                     @if($problem_table->id)
                        <form class="form-horizontal" action="{{ route('problem_tables.update', $problem_table->id) }}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                        <input type="hidden" name="_method" value="PUT">
                    @else
                        <form class="form-horizontal" role="form" action="{{route('problem_tables.store')}}" method="post" enctype="multipart/form-data">
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class='radio' style="float: left;padding-right: 10px;">
                                    <label>
                                        <input type="radio" name="sex" @if($problem_table->sex==1)checked="checked"@endif value="1">
                                        <span class="text">男</span>
                                    </label>
                                </div>
                                <div class='radio' style="float: left;padding-right: 10px;">
                                    <label>
                                        <input type="radio" name="sex" @if($problem_table->sex==0)checked="checked"@endif value="0">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                @else
                                    <input class="form-control"  placeholder="" name="address" required="" type="text" value="{{old('address',$problem_table->address)}}">
                                @endif
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="phone" required="" type="text" value="{{old('phone',$problem_table->phone)}}">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" name="back_content" style="height: 100px;">{{old('back_content',$problem_table->back_content)}}</textarea>
                                <!-- <input class="form-control"  placeholder="" name="back_content" required="" type="text" value="{{old('back_content',$problem_table->back_content)}}"> -->
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="other"  type="text" value="{{old('other',$problem_table->other)}}">
                            </div>
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="main[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address['id']}}" <?php if(in_array($address['id'],explode(',', $problem_table->main))){echo 'selected';}?>>{{$address['address']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="secondary[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address['id']}}" <?php if(in_array($address['id'],explode(',', $problem_table->secondary))){echo 'selected';}?>>{{$address['address']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="join[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address['id']}}" <?php if(in_array($address['id'],explode(',', $problem_table->join))){echo 'selected';}?>>{{$address['address']}}</option>
                                    @endforeach
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    @if($problem_table->id)
       get_images('img',"{{route('images.index',['model'=>'problem_tables-'.$problem_table->id])}}",'problem_tables');
    @else
        init_multiple('img',[],[],'problem_tables');
    @endif
