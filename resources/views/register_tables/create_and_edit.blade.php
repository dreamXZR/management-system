                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="main[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $register_table->main))){echo 'selected';}?>>{{$address->present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="secondary[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $register_table->secondary))){echo 'selected';}?>>{{$address->present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select  class="selectpicker form-control" multiple data-live-search="true" name="join[]">
                                    @foreach($addresses as $address)
                                        <option value="{{$address->id}}" <?php if(in_array($address->id,explode(',', $register_table->join))){echo 'selected';}?>>{{$address->present_address}}</option>
                                    @endforeach
                                </select>
                            </div>
