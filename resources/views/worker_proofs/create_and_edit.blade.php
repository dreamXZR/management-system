                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class='radio' style="float: left;padding-right: 10px;">
                                    <label>
                                        <input type="radio" name="child_sex" @if($worker_proof->child_sex==1)checked="checked"@endif value="1">
                                        <span class="text">男</span>
                                    </label>
                                </div>
                                <div class='radio' style="float: left;padding-right: 10px;">
                                    <label>
                                        <input type="radio" name="child_sex" @if($worker_proof->child_sex=='0')checked="checked"@endif value="0">
...
@section('afterJavaScript')
    ...
    <script type="text/javascript">
        ...
        @if($worker_proof->id)
        get_images('img',"{{route('images.index',['model'=>'worker_proofs-'.$worker_proof->id])}}","worker_proofs");

        @else
        init_multiple('img',[],[],'worker_proofs');
        @endif
